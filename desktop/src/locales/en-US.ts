export default {
	...
	settings: {
		...
		preferredResolution: {
			label: "Preferred Recording Resolution",
			original: "Original (highest)",
			hint: "Select a target quality, then choose which direction to search when it is unavailable.",
		},
		resolutionPreference: {
			label: "Fallback Direction",
			lower: "Prefer lower",
			higher: "Prefer higher",
			hint: "Uses the nearest quality in this direction first, then the nearest quality in the other direction instead of failing.",
		},
		mergeFormat: {
			label: "Merge Format",
