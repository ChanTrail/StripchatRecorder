<!--
    目录浏览器对话框组件 / Directory Browser Dialog Component

    全局单例组件，挂载于 App.vue，通过 useDirectoryBrowser() composable 控制。
    支持进入子目录、返回上级、查看驱动器、手动输入路径跳转、新建文件夹。
    移动端从底部滑入全屏覆盖层；桌面端居中 Dialog 弹窗。
-->
